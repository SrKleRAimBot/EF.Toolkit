...
namespace EFBulk.Configuration;
...
public sealed class BulkOptionsExtension : IDbContextOptionsExtension
{
    ...
    /// <summary>The EF.Bulk settings configured for this context.</summary>
        ...
        : DbContextOptionsExtensionInfo(extension)
    {
        ...
        public override string LogFragment
        {
            get
            {
                ...
                return $"using EF.Bulk (threshold={o.Threshold}, maxBatchSize={o.MaxBatchSize}, "
        ...
        {
            var o = Extension.Options;
            debugInfo["EFBulk:Threshold"] = o.Threshold.ToString(CultureInfo.InvariantCulture);
            debugInfo["EFBulk:MaxBatchSize"] = o.MaxBatchSize.ToString(CultureInfo.InvariantCulture);
            debugInfo["EFBulk:KeyAllocation"] = o.KeyAllocation.ToString();
            debugInfo["EFBulk:OnUnsupported"] = o.OnUnsupported.ToString();
            debugInfo["EFBulk:Timeout"] = o.Timeout?.ToString() ?? "(context default)";
        }
    }
}
