...
/// <summary>
///     Controls how EF.Bulk obtains values for store-generated keys when inserting.
/// </summary>
public enum KeyAllocation
{
    ...
    ///         EF.Bulk correlates on an alternate key if the entity has one, and otherwise throws
