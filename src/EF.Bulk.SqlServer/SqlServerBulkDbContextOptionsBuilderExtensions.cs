...
using EFBulk.SqlServer;
using EFBulk.SqlServer.Execution;
using EFBulk.SqlServer.Infrastructure;
...
/// <summary>
///     Enables EF.Bulk on a SQL Server <see cref="DbContext" />.
/// </summary>
public static class SqlServerBulkDbContextOptionsBuilderExtensions
{
    ...
    /// </summary>
    /// <remarks>
    ///     Use this in applications that reference both EF.Bulk.SqlServer and EF.Bulk.PostgreSQL,
