...
namespace EFBulk.SqlServer.Infrastructure;
...
// behaviour we must match exactly. EF.Bulk pins a single EF major in consequence (see
...
///     <c>base.Create()</c> yields a genuine SQL Server batch, which is what any partition EF.Bulk
