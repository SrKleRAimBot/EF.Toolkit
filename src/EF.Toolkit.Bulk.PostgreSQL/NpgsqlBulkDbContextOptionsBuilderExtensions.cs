...
using EFToolkit.Bulk.PostgreSQL;
using EFToolkit.Bulk.PostgreSQL.Execution;
using EFToolkit.Bulk.PostgreSQL.Infrastructure;
...
/// <summary>
///     Enables EF.Toolkit.Bulk on a PostgreSQL <see cref="DbContext" />.
/// </summary>
public static class NpgsqlBulkDbContextOptionsBuilderExtensions
{
    ...
    /// </summary>
    /// <remarks>
    ///     Use this in applications that reference both EF.Toolkit.Bulk.PostgreSQL and EF.Toolkit.Bulk.SqlServer,
