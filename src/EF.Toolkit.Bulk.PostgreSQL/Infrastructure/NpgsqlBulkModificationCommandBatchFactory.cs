...
namespace EFToolkit.Bulk.PostgreSQL.Infrastructure;
...
// we must match exactly. EF.Toolkit.Bulk pins a single EF major in consequence (see Directory.Packages.props),
...
///     yields a genuine Npgsql batch, which is what any partition EF.Toolkit.Bulk cannot accelerate is
///     delegated to.
/// </remarks>
