...
namespace EFToolkit.Bulk.Diagnostics;

/// <summary>
///     Diagnostic events emitted by EF.Toolkit.Bulk.
/// </summary>
/// <remarks>
///     <para>
...
{
    /// <summary>Name of the <see cref="DiagnosticListener" /> EF.Toolkit.Bulk publishes to.</summary>
    public const string ListenerName = "EF.Toolkit.Bulk";

    /// <summary>
    ///     Raised once per batch when its partitions have been planned. Payload:
    ///     <see cref="PartitionsPlannedEvent" />.
    /// </summary>
    public const string PartitionsPlanned = "EF.Toolkit.Bulk.PartitionsPlanned";

    /// <summary>
    ///     Raised once per partition after it has run. Payload:
    ///     <see cref="PartitionExecutedEvent" />.
    /// </summary>
    public const string PartitionExecuted = "EF.Toolkit.Bulk.PartitionExecuted";
    ...
    /// </summary>
    public const string ExplicitFallback = "EF.Toolkit.Bulk.ExplicitFallback";
    ...
    /// </remarks>
    public const string StagingCleanupFailed = "EF.Toolkit.Bulk.StagingCleanupFailed";
